...
@WebServlet("/surveyQuestionTypeRadio")
public class SurveyQuestionTypeRadioServlet extends HttpServlet {
	...
	protected void process(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		String htmlStr = TransformerHelper.getHtmlStr(xmlStr, getServletContext().getResourceAsStream("/question_type_radio.xsl"));
